...
public class BooksForm extends JFrame {
    ...
    public BooksForm() {
        ...
        lblIssued.setBounds(455,390,120,50);
        lblIssued.setFont(new Font("Tahoma", Font.BOLD, 23));
        textField_5 = new JTextField();
        textField_5.setColumns(10);
        textField_5.setBounds(600,400,200,34);
        background.add(textField_5);
        background.add(lblIssued);

        JButton btnAddBooks = new JButton("Add Books");
        btnAddBooks.setBounds(470, 450, 120, 50);
        ...
        btnAddBooks.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int i = BookDoc.save(bookCallNo, bookName, author, publisher, quantity, issued );
        ...
        btnBack.setBounds(665,450,120,50);
